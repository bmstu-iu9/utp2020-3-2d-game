...
controlPoints.push(new ControlPoint(957, 1013, 200, 2, [3], 5));
controlPoints.push(new ControlPoint(1241, 825, 200, 3, [null], 5));
controlPoints.push(new ControlPoint(1741, 1205, 200, 2, [4, 5], 10));
controlPoints.push(new ControlPoint(1749, 833, 200, 2, [null], 10));
controlPoints.push(new ControlPoint(1405, 413, 350, 2, [null], 8));
controlPoints.push(new ControlPoint(2649, 455, 350, 2, [8], 12));
controlPoints.push(new ControlPoint(2181, 829, 200, 2, [null], 11));
controlPoints.push(new ControlPoint(2217, 1213, 180, 3, [6, 7], 11));
controlPoints.push(new ControlPoint(2685, 1113, 220, 2, [10, 11], 12));
controlPoints.push(new ControlPoint(3705, 745, 200, 0, [9, 12], null));
...
//targets.push(new Target(449, 785, 1, getRandom()));
targets.push(new Target(443, 327, 1, getRandom()));
targets.push(new Target(703, 201, 1, getRandom()));
targets.push(new Target(227, 1202, 2, getRandom()));
targets.push(new Target(503, 1248, 2, getRandom()));
targets.push(new Target(889, 907, 3, getRandom()));
targets.push(new Target(949, 1060, 3, getRandom()));
targets.push(new Target(1309, 726, 4, getRandom()));
targets.push(new Target(1180, 760, 4, getRandom()));
targets.push(new Target(1420, 940, 4, getRandom()));
//targets.push(new Target(1503, 1148, 5, getRandom()));
targets.push(new Target(1523, 584, 7, getRandom()));
...
//targets.push(new Target(1845, 727, 6, getRandom()));
targets.push(new Target(1689, 921, 6, getRandom()));
targets.push(new Target(2065, 760, 9, getRandom()));
targets.push(new Target(2069, 885, 9, getRandom()));
//targets.push(new Target(2449, 725, 9, getRandom()));
targets.push(new Target(2423, 960, 10, getRandom()));
targets.push(new Target(2061, 1049, 10, getRandom()));
targets.push(new Target(2140, 1289, 10, getRandom()));
//targets.push(new Target(2257, 1257, 10, getRandom()));
//targets.push(new Target(2551, 731, 11, getRandom()));
targets.push(new Target(2560, 980, 11, getRandom()));
targets.push(new Target(2740, 760, 11, getRandom()));
//targets.push(new Target(2745, 1183, 11, getRandom()));
