...
const controlPoints = []
controlPoints.push(new ControlPoint(69, 137, 60, 2, [null], null));
controlPoints.push(new ControlPoint(593, 281, 170, 2, [null], null));
...
/*targets.push(new Target(897, 900, 3, getRandom()));
targets.push(new Target(953, 1056, 3, getRandom()));
targets.push(new Target(1309, 736, 4, getRandom()));
targets.push(new Target(1179, 912, 4, getRandom()));
targets.push(new Target(1413, 890, 4, getRandom()));
targets.push(new Target(1503, 1148, 5, getRandom()));
targets.push(new Target(1533, 584, 7, getRandom()));
targets.push(new Target(1233, 440, 7, getRandom()));
targets.push(new Target(2385, 299, 8, getRandom()));
targets.push(new Target(2897, 471, 8, getRandom()));
targets.push(new Target(1669, 1173, 5, getRandom()));
targets.push(new Target(1905, 1215, 5, getRandom()));
...
targets.push(new Target(2065, 757, 9, getRandom()));
targets.push(new Target(2069, 875, 9, getRandom()));
targets.push(new Target(2449, 725, 9, getRandom()));
targets.push(new Target(2423, 959, 10, getRandom()));
targets.push(new Target(2061, 1051, 10, getRandom()));
targets.push(new Target(2135, 1289, 10, getRandom()));
targets.push(new Target(2257, 1257, 10, getRandom()));
targets.push(new Target(2551, 731, 11, getRandom()));
targets.push(new Target(2559, 977, 11, getRandom()));
targets.push(new Target(2737, 757, 11, getRandom()));
